...
<head>
  ...
  <style>
    ...
    * {{ box-sizing:border-box; }}
    ...
    body {{ margin:0; background:radial-gradient(circle at 50% 5%,#1a3c5e 0%,#03101f 72%); color:#f0f4f8; font-family:"Microsoft JhengHei",sans-serif; line-height:1.75; line-break:strict; overflow-wrap:break-word; }}
    h1,h2,h3,p,li,td,figcaption {{ text-wrap:pretty; line-break:strict; hyphens:none; }}
    h1,h2,h3 {{ overflow-wrap:normal; }}
    @supports(word-break:auto-phrase) {{ body,h1,h2,h3,p,li,td,figcaption {{ word-break:auto-phrase; }} }}
    a {{ color:var(--aqua); }}
